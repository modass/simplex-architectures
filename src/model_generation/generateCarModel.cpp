...
hypro::HybridAutomaton<double> generateCarModel(std::size_t theta_discretization, double cycleTime, double bcvelocity, bool includeThetaTransitions) {
